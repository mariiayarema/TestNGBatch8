...
public class AserrtionDemo {
    ...
    public void logoValidation() {
        ...
        System.out.println("Text before assertion");
        //We use assertTrue if we are looking to return tru(logo isDisplayed=true)
        Assert.assertTrue(logoElement.isDisplayed(),"Logo is Displayed");
        //We can add message --> ,"textMessage"
...
//        }
    ...
    public void invalidCredentials() {
        ...
        String expectedErrorMessageText="Invalid credentials";
        ...
        //We use assert equal for comparing two Strings. Example below
        Assert.assertEquals(errorText,expectedErrorMessageText);
